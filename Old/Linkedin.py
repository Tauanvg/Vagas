        ...
        def Linhas(tenta):
            while True:
                try:
                    ...
                    driver.execute_script(f'document.getElementsByClassName("job-flavors__flavor").style.zoom="{1}%"')
            ...
            while True:
                try:
                    ...
                    ok = driver.find_element(By.XPATH,
                                             '/html/body/div[6]/div[3]/div[3]/section/div/div/div/div/div/button')
            tenta = 0
            while True:
                try:
